            ...
            <div class="row justify-content-center">
                <div class="col-sm-10">
                    <div class="heading-title white iq-breadcrumb-title iq-mtb-100">
                        <h1 class="title iq-tw-7">BLOG Two COLUMNS</h1>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Blog 2 Columns</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section id="blog" class="iq-page-blog overview-block-ptb">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 re4-mt-50">
                        <div class="iq-blog-box">
                            <div class="iq-blog-image clearfix">
